...
public class ProjectInfoDto {
	...
	private int project_percentage;// 달성률 = (현재금액 / 목표금액)*100;
	private int project_d_day;// 잔여기간 목표일 - 오늘날짜
	...
	public String toString() {
		return "ProjectInfoDto [project_no=" + project_no + ", project_percentage=" + project_percentage
