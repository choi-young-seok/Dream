...
CREATE TABLE Dream_Project (
	...
	Project_Start_Date       TIMESTAMP     DEFAULT sysdate, -- 프로젝트 시작일자
	Project_End_Date         TIMESTAMP     , -- 프로젝트 종료일자
	Project_Video            VARCHAR2(300) DEFAULT 'NO VALUE', -- 프로젝트 소개영상
	...
	Project_Account_Number   VARCHAR2(15)  DEFAULT 0, -- 프로젝트 계좌번호
	...
	Project_Supporting_Count INTEGER       DEFAULT 0, -- 현재 후원 수
